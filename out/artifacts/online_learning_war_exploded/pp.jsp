<%@ page import="com.sun.source.tree.IfTree" %><%--
...
<div class="wrapper">
    ...
    <div class="common_section" id="faicons" style="background:#f7f7f7;">
        <div class="container">
            ...
            <div class="insider">
                ...
                <div class="iconblock">
                    <span class="fa fa-calculator"><a href="#">Project Practice</a></span> &nbsp;
                </div>
    ...
    <div class="feature_section" id="features">
        <div class="container">
            ...
            <div class="leftside">
                <img src="images/thumbs/p1.png" alt=""  class="wow bounceInLeft animated" data-wow-duration="2s" data-wow-offset="300" data-wow-delay="0.2s" />
            </div>
    ...
    <div class="feature_section" id="features">
        <div class="container">
            ...
            <div class="leftside">
                <img src="images/thumbs/p2.png" alt=""  class="wow bounceInLeft animated" data-wow-duration="2s" data-wow-offset="300" data-wow-delay="0.2s" />
            </div>


            <div class="rightside">
                <h2>(MTC) use Vue to develop music player webapp</h2>
                <p>
                    Designing is a matter of concentration. You go deep into what you want to do. It's about intensive research, really. The concentration is warm and intimate and like the fire inside the earth - intense but not distorted. You can go to a place, really feel it in your heart. It's actually a beautiful feeling.
                </p>
                ...
                <a href="vue.jsp" class="button3">Learning Now</a>
    ...
    <div class="feature_section" id="features">
        <div class="container">
            ...
            <div class="leftside">
                <img src="images/thumbs/p3.png" alt=""  class="wow bounceInLeft animated" data-wow-duration="2s" data-wow-offset="300" data-wow-delay="0.2s" />
            </div>


            <div class="rightside">
                <h2>(MTC) development of document community based on nodejs</h2>
                <p>
                    Designing is a matter of concentration. You go deep into what you want to do. It's about intensive research, really. The concentration is warm and intimate and like the fire inside the earth - intense but not distorted. You can go to a place, really feel it in your heart. It's actually a beautiful feeling.
                </p>
                ...
                <a href="node.jsp" class="button3">Learning Now</a>
                <a href="#" class="button4">$99</a>
            </div>
